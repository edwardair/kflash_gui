...
if sys.platform.startswith("win32"):
    ...
    cmd = 'pyinstaller --key=stupidantivirus --add-data="kflash_gui_data;kflash_gui_data" --add-binary="kflash_py;kflash_py" -i="kflash_gui_data/assets/logo.ico" --noconfirm --clean kflash_gui.py'
